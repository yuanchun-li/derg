 ...
 */
public class SimpleSootBuilder extends DERGFrontend {
    public static final String NAME = "soot_simplified";
    public static final String DESCRIPTION = "build simple DERG from java (android) using soot.";
    ...
    public void parseArgs(String[] args) throws ParseException {
        ...
        try {
            ...
            formatter.printHelp(SimpleSootBuilder.NAME, options, true);
            throw new ParseException("Parsing arguments failed in " + SimpleSootBuilder.NAME);
        }
    }

    private boolean init() {
        Util.LOGGER.info("Start Initializing " + SimpleSootBuilder.NAME);
        ...
        Util.LOGGER.info("Finish Initializing " + SimpleSootBuilder.NAME);
        return true;
    }
